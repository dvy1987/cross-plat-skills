...
Generated by `library-skill` on 2026-05-06.
...
- **Entry points** — skills users invoke directly: `universal-skill-creator`, `improve-skills`, `learn-from-paper`, `reality-check`, `project-orchestrator`, `project-setup`, `process-decomposer`, `agent-builder`, `deep-thinking`, `brainstorming`, `prd-writing`, `product-soul`, `venture-exploration`
