...
| [`learn-from-chat`](.agents/skills/learn-from-chat/) | Captures actionable learnings that emerge during conversation — when a skill rule, gotcha, or process step needs to be updated based on what's happening now | **Files modified:** target SKILL.md + logged | "we should update the skill for this", "add this as a gotcha", "remember this for next time" |
